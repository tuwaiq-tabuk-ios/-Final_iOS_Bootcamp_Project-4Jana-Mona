...
class FirebaseManager {
    ...
    func createAccount(userName: String, email: String, password: String) {
        ...
        Auth.auth().createUser(withEmail: email, password: password) { (result, error) in
            ...
            if let _ = result {
                let vc = UIStoryboard.mainStoryboard.instantiateViewController(withIdentifier: "SignInViewController1")
  ...
  func loginWithEmail(email: String, password: String) {
    ...
    func addTool(image: UIImage?, type: Constants.sections) {
    ...
    private func uploadImage(image: UIImage?, completion: @escaping (_ url: String, _ isError: Bool?) -> Void) {
